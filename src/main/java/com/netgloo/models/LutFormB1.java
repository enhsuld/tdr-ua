...
/**
 * The persistent class for the LUT_FORM_B1 database table.
 * 
 */
@Entity
@Table(name="LUT_FORM_B1")
@NamedQuery(name="LutFormB1.findAll", query="SELECT l FROM LutFormB1 l")
public class LutFormB1 implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="LUT_FORM_B1_SEQ", sequenceName="LUT_FORM_B1_SEQ",allocationSize=1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE ,generator="LUT_FORM_B1_SEQ")
