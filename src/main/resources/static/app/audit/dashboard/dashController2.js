    ...
    .controller('issuesCtrl', [
       ...
       /*     	var workbook = Workbook.Load(x);  
            ...
            $scope.showGB42= function(){
				...
				if($scope.editable){
					//$scope.showGBGRID42.toolbar.unshift("save");
            ...
            $scope.showGB44= function(){
				...
				if($scope.editable){
					$scope.showGBGRID44.toolbar.unshift("save");
				}
            }
            ...
            $scope.showGB45= function(){
				...
				if($scope.editable){
					$scope.showGBGRID45.toolbar.unshift("save");
				}
            }
            ...
            $scope.showGB46= function(){
				...
				if($scope.editable){
					$scope.showGBGRID46.toolbar.unshift("save");
				}
            }
            ...
            $scope.showGB461= function(){
				...
				if($scope.editable){
					$scope.showGBGRID461.toolbar.unshift("save");
				}
            }
            ...
            $scope.showGB462= function(){
				...
				if($scope.editable){
					$scope.showGBGRID462.toolbar.unshift("save");
				}
            }
            ...
            $scope.showGB463= function(){
				...
				if($scope.editable){
					$scope.showGBGRID463.toolbar.unshift("save");
				}
            }
/*            
            ...
            $scope.showGB464= function(){
				...
				if($scope.editable){
					$scope.showGBGRID464.toolbar.unshift("save");
				}
            }
            ...
            var modalgb25 = UIkit.modal("#modal_b_25");
            
        	var modalUriskNew = UIkit.modal("#modal_b_25_new");
    		$scope.risk={};
    		
            $scope.addNew=function(i){
            	$ocLazyLoad.load('app/audit/customRisk/customRiskController.html').then(function(){
					$scope.load_modal = 'app/audit/customRisk/customRiskView2.html';
				});
         ...
         /*       mainService.withdomain('get','/au/withid/MainAuditRegistration/'+$stateParams.issueId)
            	...
            	console.log($scope.dir_data.options);
		   					...
		   					$scope.risks=rdata;
		 		                ...
		 		                columns: [
			  	   			    ...
			  	   			    if($scope.role=="ROLE_AUDIT" && $scope.note_form.step!=3){	   		   						
			  		            	...
			  		            	$scope.puserGridM25.columns.push({template: $("#update").html(), width:250,  locked: true});
		  	  					}
            ...
            $scope.showGB465= function(){
				...
				if($scope.editable){
					$scope.showGBGRID465.toolbar.unshift("save");
				}
            }
