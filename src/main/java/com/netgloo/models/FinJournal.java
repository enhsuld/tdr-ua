...
public class FinJournal implements Serializable {
	...
	@Id
	@SequenceGenerator(name="FIN_JOURNAL_SEQ", sequenceName="FIN_JOURNAL_SEQ",allocationSize=1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE ,generator="FIN_JOURNAL_SEQ")
