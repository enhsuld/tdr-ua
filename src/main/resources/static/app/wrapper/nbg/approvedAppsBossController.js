	        ...
	        function ($scope,$rootScope,$state,$timeout,p_apps,sweet,mainService,p_specialist,p_pos) { 
	          ...
	          $scope.pmenuGrid = {
		                dataSource: {
		                    ...
		                    transport: {
		                    	read:  {
		                            url: "/izr/user/angular/ApplicationRegistrationApproved",
		                ...
		                columns: [
								...
								{ field: "statusid", title: "<span data-translate='Өргөдлийн явц'></span>"},
								{ field: "approvedate", title: "<span data-translate='Шийдвэрлэсэн огноо'></span>"},								
								{ field: "officerid", title: "<span data-translate='Мэргэжилтэн'></span>"},																
								{ field: "userposition", title: "<span data-translate='Албан тушаал'></span>"},								
