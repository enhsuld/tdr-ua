...
public class FinCtt2 implements Serializable {
	...
	@Id
	@SequenceGenerator(name="FIN_CTT2_SEQ", sequenceName="FIN_CTT2_SEQ",allocationSize=1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE ,generator="FIN_CTT2_SEQ")
	...
	public String toString() {
		return "FinCtt2 [id=" + id + ", data1=" + data1 + ", data2=" + data2 + ", data3=" + data3 + ", data4=" + data4
				+ ", data5=" + data5 + ", data6=" + data6 + ", formid=" + formid + ", orgcatid=" + orgcatid
