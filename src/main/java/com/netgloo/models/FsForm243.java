 ...
 */
@Entity
@Table(name="FS_FORM_243")
@NamedQuery(name="FsForm243.findAll", query="SELECT f FROM FsForm243 f")
public class FsForm243 implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="FS_FORM_243_SEQ", sequenceName="FS_FORM_243_SEQ",allocationSize=1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE ,generator="FS_FORM_243_SEQ")
