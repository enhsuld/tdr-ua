...
public class FinAbw implements Serializable {
	...
	@Id
	@SequenceGenerator(name="FIN_ABWS_ID_SEQ", sequenceName="FIN_ABWS_SEQ",allocationSize=1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE ,generator="FIN_ABWS_ID_SEQ")
