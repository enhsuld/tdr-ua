...
public class FinBudget implements Serializable {
	...
	@Id
	@SequenceGenerator(name="FIN_BUDGET_SEQ", sequenceName="FIN_BUDGET_SEQ",allocationSize=1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE ,generator="FIN_BUDGET_SEQ")
