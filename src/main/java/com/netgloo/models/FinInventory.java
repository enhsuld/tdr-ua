...
public class FinInventory implements Serializable {
	...
	@Id
	@SequenceGenerator(name="FIN_INVENTORY_SEQ", sequenceName="FIN_INVENTORY_SEQ",allocationSize=1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE ,generator="FIN_INVENTORY_SEQ")
