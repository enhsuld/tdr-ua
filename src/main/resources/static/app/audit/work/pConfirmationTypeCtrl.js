    ...
    .module('altairApp')
    	.controller("confTypeCtrl", [
	        ...
	        function ($scope,$rootScope,$state,$timeout,sweet,mainService,user_data) { 
    	      ...
    	      var modal_update = UIkit.modal("#modal_update");
    	      
    	      $scope.domain="com.netgloo.models.LutConfirmationType.";
    	      ...
    	      $scope.edit = function(id){
    	    	  mainService.withdomain('get', '/my/resource/LutConfirmationType/'+id).
	    			then(function(data){
    	      ...
    	      if(user_data[0].role=="ROLE_SUPER"){
	    		  $scope.puserGrid = {
			                dataSource: {
			                    ...
			                    transport: {
			                    	read:  {
			                    		url: "/my/list/LutConfirmationType",
			                ...
			                columns: [
									{ field: "name", title: "Нотлох зүйлийн төрөл" +"<span data-translate=''></span>"},
