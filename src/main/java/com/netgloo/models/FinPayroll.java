...
/**
 * The persistent class for the FIN_PAYROLL database table.
 * 
 */
@Entity
@Table(name="FIN_PAYROLL")
@NamedQuery(name="FinPayroll.findAll", query="SELECT f FROM FinPayroll f")
public class FinPayroll implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="FIN_PAYROLL_SEQ", sequenceName="FIN_PAYROLL_SEQ",allocationSize=1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE ,generator="FIN_PAYROLL_SEQ")
