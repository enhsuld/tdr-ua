angular
    .module('altairApp')
    	.controller("worklistCtrl", [
    	                           ...
    	                           'user_data',
    	                           'mainService',
	        function ($scope,$rootScope,$state,$timeout,p_dep,user_data,mainService) { 
	    	  ...
	    	  if(user_data[0].role=="ROLE_SUPER"){
	    		  $scope.pmenuGrid = {
			                ...
			                columns: [								
									...
									{ field: "categotyid", title: "Ангилал" +"<span data-translate=''></span>", width: 250},
									{ field: "fincategoryid", title: "Санхүүжилтийн хэлбэр" +"<span data-translate=''></span>",  width: 250},
									{ field: "progid", title: "Төсвийн зарлагын хөтөлбөрийн ангилал" +"<span data-translate=''></span>", width: 250},
 	    			...
 	    			function initq(){
          	            ...
          	            if(data.rcreate==1){	   		   					  
	   		   					if(data.rexport==1){
	   		   					  $scope.pmenuGrid.toolbar=["create","excel","pdf"];
	   		   					}
	   		   					else{
