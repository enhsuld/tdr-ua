...
public class FinTrialBalance implements Serializable {
	...
	@Id
	@SequenceGenerator(name="FIN_TRIAL_BALANCE_SEQ", sequenceName="FIN_TRIAL_BALANCE_SEQ",allocationSize=1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE ,generator="FIN_TRIAL_BALANCE_SEQ")
