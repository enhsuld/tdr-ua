angular
    ...
    .controller('dashboardCtrl', [
        ...
        'userStatOrg',
        'variables',
        function ($rootScope,$scope,$interval,$timeout,$window,sale_chart_data,user_data,plot_data,userStat,catStat,userStatOrg,variables) {
        	
        	
        	 
        	$scope.user_option = {
        		    title: {
        		        text: 'Тэргүүлэх баталгаажуулсан',
        		        subtext: 'Ажлын тоо'
        		    },
        		    tooltip: {
        		        trigger: 'axis',
        		    ...
        		    yAxis: {
        		        type: 'category',
        		        data: userStatOrg.yaxis
        		    }
        		};
        	
        	  $scope.user_option_data = [
        		  {
  		            name: '2018 он',
  		            type: 'bar',
  		            data:  userStatOrg.xaxis
  		        },
            ];
        	...
        	angular.forEach(catStat.countttz, function(value, key) {
	    		 if(value>maxcount){
	    			 maxcount=value;
	    		 }
    		});
        	angular.forEach(catStat.counttez, function(value, key) {
	    		 if(value>maxcount){
	    			 maxcount=value;
	    		 }
        	});
        	...
        	$scope.ttztez_option = {
        		    ...
        		    toolbox: {
        		        feature: {
        		            dataView: {show: true, title:'Хүснэгт', readOnly: false},
        		            magicType: {show: true, title:'Шугам', type: ['line', 'bar']},
        		            restore: {show: true, title:'Шинэчлэх'},
        		            saveAsImage: {show: true, title:'Зураг'}
        		        }
        		    },
        		    legend: {
        		        data:['ТТЗ','ТЕЗ','Хувь-ТТЗ','Хувь-ТЕЗ']
        		    },
        		    xAxis: [
        		        {
        		            type: 'category',
            ...
            $scope.ttztez_data = [
            	  {
  		            name:'ТТЗ',
  		            type:'bar',
  		            data:catStat.countttz
  		        },
  		        {
  		            name:'ТЕЗ',
  		            type:'bar',
  		            data:catStat.counttez
  		        },
  		        {
  		            name:'Хувь-ТТЗ',
  		            type:'line',
        	...
        	$scope.userStat=userStat;
        	$scope.chartConfig={
        		/*title: {
	                text: "Албан тушаалаар багцласан ажлын  гүйцэтгэлийн хувь."
	            },*/
	            categoryAxis: {
	                field: "depname",
	                majorGridLines: {
