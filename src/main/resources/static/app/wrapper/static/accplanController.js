    ...
    .module('altairApp')
    	.controller("accplanCtrl", [
	        ...
	        function ($scope,$rootScope,$state,$timeout,mainService,user_data) { 
	    	  ...
	    	  $scope.domain="com.netgloo.models.LutAccplan.";	    	
	    		  ...
	    		  $scope.puserGrid = {
			                    ...
			                    schema: {
			                         ...
			                         model: {                                	
			                        	 ...
			                        	 fields: {   
			                        		 ...
			                        		 acccode: { type: "string", validation: { required: true } },
			                        		 accname: { type: "string", validation: { required: true } },
			                ...
			                columns: [
			                	{ title: "#",template: "<span class='row-number'></span>", width:"60px"},
									{ field: "acccode", title: "Дансны код"},
									{ field: "accname", title: "Дансны нэр"},
									{ field: "freebalance", title: "FREE BALANCE"},
									{ field: "fiscal", title: "FISCAL"},								
