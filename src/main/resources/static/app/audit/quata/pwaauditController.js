angular
    .module('altairApp')
    	.controller("waauditCtrl",['$scope','user_data','mainService','sweet','$state','p_cat','au_levels','reason',
		   			                ...
		   			                dataSource: {
		   			                    ...
		   			                    transport: {
		   			                    	read:  {
		   			                            ...
		   			                            data:{"userid":user_data[0].id, "isarchive":true, "depid":user_data[0].depid, "isactive":1},
		   			                            type:"POST"
		   			                        },
		   			                        update: {
