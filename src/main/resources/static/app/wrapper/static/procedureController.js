    ...
    .module('altairApp')
    	.controller("procedureCtrl", [
	        ...
	        function ($scope,$rootScope,$state,$timeout,mainService,user_data) { 
	    	  ...
	    	  $scope.domain="com.netgloo.models.LutProcedure.";
	    		  ...
	    		  $scope.puserGrid = {
			                    ...
			                    schema: {
			                         ...
			                         model: {                                	
			                        	 ...
			                        	 fields: {   
			                        		 ...
			                        		 adescribe: { type: "string", validation: { required: true } },
			                        		 aprocedure: { type: "string", validation: { required: true } },
			                        		 standart: { type: "string", validation: { required: true } },
			                        		 way: { type: "string", validation: { required: true } },		                        		 		                        		 
			                             }
			                         }
			                     },
			                    pageSize: 8,
			                ...
			                columns: [
			                	{ title: "#",template: "<span class='row-number'></span>", width:"60px"},
									{ field: "aprocedure", title: "Горимын төрөл"},
									{ field: "adescribe", title: "Тайлбар"},
									{ field: "standart", title: "Холбогдох стандарт"},
									{ field: "way", title: "Горимыг хэрэгжүүлэх арга зам"},								
