...
public class FinTgt1a implements Serializable {
	...
	@Id
	@SequenceGenerator(name="FIN_TGT1A_SEQ", sequenceName="FIN_TGT1A_SEQ",allocationSize=1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE ,generator="FIN_TGT1A_SEQ")
