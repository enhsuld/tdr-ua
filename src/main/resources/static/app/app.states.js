    ...
    .config([
        ...
        function ($stateProvider, $urlRouterProvider,$httpProvider) {
            ...
            // -- ERROR PAGES --
                ...
                .state("error.Auth", {
                    url: "/auth",
                    templateUrl: 'app/components/pages/error_AuthView.html'
                })
                // -- LOGIN PAGE --
                .state("login", {
                    url: "/login",
                    templateUrl: 'app/wrapper/static/loginView.html',
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function($ocLazyLoad) {
                            return $ocLazyLoad.load([
                                ...
                                'lazy_parsleyjs',
                                'lazy_uikit',
                                'app/wrapper/static/loginController.js'
                            ]);
                        }]
                    }
                })
            ...
            // -- DASHBOARD --
                .state("restricted.dashboard", {
                    url: "/",
                    templateUrl: 'app/audit/stat/dashboardView.html',
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function($ocLazyLoad) {
                            return $ocLazyLoad.load([
                                ...
                                'lazy_google_maps',
                                'lazy_echarts',
                                'app/audit/stat/dashboardController.js'
                            ], {serie: true} );
                        }],
                        ...
                        plot_data: function($http,$state,user_data){
	                        return $http({ method: 'GET', url: '/chart/plotBands/1' })
	                            .then(function (data) {
	                            	return data.data;
	                            });
                		},
                		userStat: function($http,$state,user_data){
 	                        return $http({ method: 'GET', url: '/chart/userStat/'+user_data[0].id})
 	                            .then(function (data) {
 	                            	return data.data;
 	                            });
                 		},
                 		catStat: function($http,$state,user_data){
 	                        return $http({ method: 'GET', url: '/chart/catStat/'+user_data[0].id})
	                            .then(function (data) {
	                            	return data.data;
	                            });
             		    },
                 		userStatOrg: function($http,$state,user_data){
 	                        return $http({ method: 'GET', url: '/chart/userStatOrg/'+user_data[0].depid})
 	                            .then(function (data) {
 	                            	return data.data;
 	                            });
                 		}
