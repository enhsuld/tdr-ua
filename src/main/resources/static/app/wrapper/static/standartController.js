    ...
    .module('altairApp')
    	.controller("standartCtrl", [
	        ...
	        function ($scope,$rootScope,$state,$timeout,mainService,sweet,user_data) { 
    	               	    			...
    	               	    			$scope.lcat=[
    	               	    					{value:2, text:'Стандарт'} , {value:3, text:'Бусад' }
    	               	    			];
    	               	    			var lcat=$scope.lcat;
    	               	    			console.log(lcat);
    	               	    			...
    	               	    			$scope.mainGridOptions = {
    	               	   		          dataSource: {
    	               	   		        	  ...
    	               	   		        	  transport: {
    	               	   		        		   read:  {
    	               	   	                            ...
    	               	   	                            data: { "custom":"where parentid is null and lawcategory in (2,3)","sort":[{field: 'id', dir: 'asc'}]},
    	               	   	                            type:"POST"
    	               	   	                        },
    	               	   	                        update: {
    	               	   		              ...
    	               	   		              schema: {
    	               	                        	...
    	               	                        	total:"total",
    	               	                        	 model: {                                	
    	               	                                ...
    	               	                                lawcategory: {nullable: false, type: "number" },
    	               	     	          ...
    	               	     	          editable: 'inline',
    	               	   		          columns: [    	               	   	                    
    	               	   	                    ...
    	               	   	                    { field:"lawcategory", title: "Төрөл", width: "200px", editor: categoryDropDownEditor, values:lcat},
    	               			            ...
    	               			            dataSource: {
    	               			              ...
    	               			              transport: {
    	               			            		read:  {
    	               		            			    url: "/info/list/LutLaw",
    	               		                            contentType:"application/json; charset=UTF-8",     
    	               		                            data: { "custom":"where parentid is not null and lawcategory in (2,3)","sort":[{field: 'id', dir: 'asc'}]},
    	               		                            type:"POST"
    	               		                        },
	    	               		                     update: {
	 	               	   	                            url: "/core/update/"+$scope.domain+"",
    	               			              ...
    	               			              schema: {
    	               	                     	...
    	               	                     	model: {                                	
    	               	                             ...
    	               	                             fields: {   
	                	                             	...
	                	                             	lawname: { type: "string", validation: { required: true } },    
	                	                             	lawcategory: {nullable: false, type: "number",  defaultValue: dataItem.lawcategory },
    	               	                             }	                    
    	               	                         }
    	               	                      },
    	               			              serverPaging: true,
